...
import importedData from '../../assets/yield-gap-vs-nitrogen-pollution.csv';
import d3Tip from "d3-tip";

function NitroPollution() {
    useEffect(() => {
        // The svg
        ...
        const colorScale = d3.scaleThreshold()
            .domain([-150, -100, -50, 0, 50, 100, 150, 200])
        ...
        Promise.all([
            ...
            d3.csv(importedData, function (d) {
                ...
                var legendData = [-150, -100, -50, 0, 50, 100, 150, 200];
